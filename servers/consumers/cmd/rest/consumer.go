...
import (
	...
	"github.com/weridolin/simple-vedio-notifications/servers/consumers/cmd/rest/internal/handler"
...
var configFile = flag.String("f", "etc/emailnotifier.yaml", "the config file")
