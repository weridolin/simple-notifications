...
func CreateSchedulerHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateSchedulerReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := scheduler.NewCreateSchedulerLogic(r.Context(), svcCtx)
		resp, err := l.CreateScheduler(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
