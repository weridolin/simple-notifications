...
func (u EmailNotifierSerializer) FromEmailNotifierModel(m *database.EmailNotifier, user database.User) *EmailNotifierSerializer {
...
func (u EmailNotifierSerializer) FromEmailNotifierModels(m []*database.EmailNotifier, user database.User) []*EmailNotifierSerializer {
	var res []*EmailNotifierSerializer
	for _, v := range m {
		s := u.FromEmailNotifierModel(v, user)
		res = append(res, s)
	}
	return res
}
